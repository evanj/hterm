...
build/closure-compiler-v20161201.jar:  | 
	curl --location https://dl.google.com/closure-compiler/compiler-20161201.tar.gz | tar xvfz - -C build closure-compiler-v20161201.jar

build/js:  | 
	mkdir -p $@

build/js/hterm_all.js: build/closure-compiler-v20161201.jar build/libapps | build/js
...
build/__tests__/consolechannel-test.js: js/consolechannel.js __tests__/consolechannel-test.js js/hterm_externs.js js/jasmine-2.0-externs.js js/node_externs.js build/closure-compiler-v20161201.jar | 
...
build/js/htermshell.js: js/consolechannel.js js/htermshell.js js/hterm_externs.js js/node_externs.js build/closure-compiler-v20161201.jar | 
...
build/uncompiled_tests.teststamp: __tests__/consolechannel-test.js js/htermshell.js | 
	npm test
	touch $@
